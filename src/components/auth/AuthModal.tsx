      ...
      <DialogContent className="sm:max-w-md p-0 overflow-hidden border-border/50 gap-0">
        ...
        <div className="gradient-bg p-6 text-center">
          <div className="flex items-center justify-center gap-3 mb-2">
            <img src="/whisk_udaan_setu.png" alt="Whisk Udaan Setu" className="h-10 w-10 rounded-full object-cover border-2 border-primary-foreground/30" />
            <span className="font-display text-xl font-bold text-primary-foreground">Udaan Setu</span>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`flex items-center gap-2 p-3 rounded-lg border-2 transition-all ${role === 'client' ? 'border-primary bg-primary/5' : 'border-border hover:border-primary/50'
                  }`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-2 p-3 rounded-lg border-2 transition-all ${role === 'influencer' ? 'border-primary bg-primary/5' : 'border-border hover:border-primary/50'
                  }`}
              >
